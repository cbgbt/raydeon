...
pub struct LineSegment3D<'s, Space>
where
    Space: Copy + Clone + std::fmt::Debug,
{
    ...
    shape: Option<&'s DrawableShape>,
}

impl<'s, Space> LineSegment3D<'s, Space>
where
    Space: Copy + Clone + std::fmt::Debug,
{
    pub fn new_segment(
    ...
    pub fn cast_unit<U>(self) -> LineSegment3D<'s, U>
    where
        U: Copy + Clone + std::fmt::Debug,
    {
        LineSegment3D::new()
            ...
            .maybe_shape(self.shape)
            .build()
    }

    pub fn xy(self) -> LineSegment2D<'s, Space> {
        LineSegment2D::new()
            .p1(self.p1.xy())
            .p2(self.p2.xy())
            .maybe_shape(self.shape)
    ...
    pub fn yz(self) -> LineSegment2D<'s, Space> {
        LineSegment2D::new()
            .p1(self.p1.yz())
            .p2(self.p2.yz())
            .maybe_shape(self.shape)
    ...
    pub fn xz(self) -> LineSegment2D<'s, Space> {
        LineSegment2D::new()
            .p1(self.p1.xz())
            .p2(self.p2.xz())
            .maybe_shape(self.shape)
    ...
    pub fn set_shape(&mut self, shape: &'s DrawableShape) {
        self.shape = Some(shape);
    }

    pub fn get_shape(&self) -> Option<&DrawableShape> {
        self.shape
    }
}

/// Created when a segment is chopped into several smaller pieces
pub struct SlicedSegment3D<'parent, 's, Space>
where
    Space: Copy + Clone + std::fmt::Debug,
{
    num_chops: usize,
    included: BTreeSet<usize>,
    parent: &'parent LineSegment3D<'s, Space>,
}

impl<'parent, 's, Space> SlicedSegment3D<'parent, 's, Space>
where
    Space: Copy + Clone + std::fmt::Debug,
{
    pub fn new(num_chops: usize, parent: &'parent LineSegment3D<'s, Space>) -> Self {
    ...
    pub fn join_slices(&self) -> Vec<LineSegment3D<'s, Space>> {
...
#[derive(Debug, Copy, Clone, Builder)]
#[builder(start_fn(name = new))]
pub struct LineSegment2D<'s, Space>
where
    Space: Copy + Clone + std::fmt::Debug,
{
    #[builder(into)]
...
impl<'s, Space> LineSegment2D<'s, Space>
where
    Space: Copy + Clone + std::fmt::Debug,
{
    ...
    pub fn cast_unit<U>(self) -> LineSegment2D<'s, U>
    where
        U: Copy + Clone + std::fmt::Debug,
    {
        LineSegment2D::new()
    ...
    pub fn to_3d(&self) -> LineSegment3D<'s, Space> {
        LineSegment3D::new()
            .p1(self.p1.to_3d())
            .p2(self.p2.to_3d())
            .maybe_shape(self.shape)
