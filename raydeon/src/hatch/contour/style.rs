...
//! engine's job (`contour::mod`). This module only states, and validates,
//! what a material is asking for.

use super::super::lines::SAMPLE_LEN;
use super::super::style::{HatchStyle, ToneThreshold};
use bon::Builder;
use nutype::nutype;
